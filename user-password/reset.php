...
<!-- Mirrored from boomchart.net/bitmine/user-password/reset by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 11 Feb 2021 23:25:26 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
        <base />
        <title>Send Link password | Bitmine</title>
        <meta charset="utf-8" />
        ...
        <div class="header-body text-center mb-7">
          <div class="row justify-content-center">
            <div class="col-xl-5 col-lg-6 col-md-8 px-5">
              ...
              <p class="text-lead text-white">Start bitcoin mining today</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="container mt--8 pb-5">
      <div class="row justify-content-center">
        <div class="col-lg-5 col-md-7">
          ...
          <div class="row mt-3">
            <div class="col-6">
              <a href="../login.html" class="text-white"><small>Sign in</small></a>
            </div>
            <div class="col-6 text-right">
              <a href="../register.html" class="text-white"><small>Create new account</small></a>
            </div>
          </div>
        </div>
      </div>
