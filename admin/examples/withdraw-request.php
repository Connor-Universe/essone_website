...
<div class="wrapper">
    ...
    <tbody>
        ...
        while($row_user = mysqli_fetch_array($run_user)){
         ...
         $transaction_id = $row_user['transaction_id'];
          if($verified == false){
              $verifieds = "False";
              $dis = "";
          }else{
        ...
        $email_user = $row_user['email'];
          ...
          <tr>
           ...
           <input class='form-control' type='text' placeholder='transaction id' name='transaction'>
           <input type='hidden' name='reference' value='$reference'>
           <button type='submit' class='btn btn-primary' name='withdraw'>Update Id</button>
         </form>  
           </td>  
           <td>     
           <a href='verify_withdraw.php?id=$id&&amount=$amount_dollar&&no=$id_no&&name=$first_name&&wallet=$wallet&&email=$email_user&&transaction=$transaction_id' rel='tooltip' class='btn btn-primary btn-sm btn-icon' $dis>
