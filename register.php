...
<!-- Mirrored from boomchart.net/bitmine/register by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 11 Feb 2021 23:22:59 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
        <base />
        <title>Register | Essone</title>
        <meta charset="utf-8" />
        ...
        <div class="header-body text-center mb-7">
          <div class="row justify-content-center">
            <div class="col-xl-5 col-lg-6 col-md-8 px-5">
              ...
              <p class="text-lead text-white" style="text-transform: capitalize;">Start bitcoin investment today</p>          
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="container mt--8 pb-5">
      <div class="row justify-content-center">
        <div class="col-lg-5 col-md-7">
            ...
            <div class="card-body px-lg-5 py-lg-5">
                    ...
                    <?php echo"$btc_address_error";?>
                      ...
                      <div class="input-group input-group-merge input-group-alternative">
                        ...
                        <input class="form-control" placeholder="bitcoin address(optional)" type="text" name="wallet">
                    ...
                    <div class="form-group">
                      <div class="input-group input-group-merge input-group-alternative">
                        ...
                        <input class="form-control" placeholder="NO Referal" type="text" name="code" value="<?php echo"$referal";?>" <?php echo"$dis";?>>
                    ...
                    <div class="form-group mb-3">
                      <div class="input-group input-group-merge input-group-alternative">
                        ...
                        <input class="form-control" placeholder="Re Enter Password" type="password" name="password2">
          ...
          <!-- <div class="row mt-3">
            <div class="col-6">
              <a href="user-password/reset.php" class="text-white"><small>Forgot password?</small></a>
            </div>
